...
function BrandMark() {
	return (
		<span className="grid size-8 place-items-center rounded-lg bg-primary text-primary-foreground shadow-luminous">
			...
			>
				<motion.div {...reveal}>
					<span className="mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-background/70 px-3 py-1.5 text-xs font-medium shadow-sm backdrop-blur">
						<Sparkles className="size-3.5 text-primary" /> The creative
						operating system
					</span>
					...
					<p className="mx-auto mt-6 max-w-2xl text-balance text-base leading-7 text-muted-foreground md:text-lg">
						Manage bookings, deliver stunning client galleries, and automate
			...
			<section id="features" className="mx-auto max-w-6xl px-5 py-24 md:py-32">
				<motion.div {...reveal} className="max-w-2xl">
					...
					<p className="mt-5 text-muted-foreground">
						Every client touchpoint, beautifully considered and perfectly in
						sync.
					</p>
				</motion.div>
					...
					>
						...
						<div className="relative mt-7 h-[390px]">
							<motion.img
								...
								height={1504}
								loading="lazy"
								className="absolute left-2 top-2 h-72 w-48 -rotate-6 rounded-md border-[6px] border-card object-cover shadow-xl"
							/>
							<motion.img
								whileHover={{ rotate: 2, scale: 1.02 }}
								src="/images/lumodesk-editorial.jpg"
								...
								height={1104}
								loading="lazy"
								className="absolute left-12 top-24 h-52 w-48 rotate-6 rounded-md border-[6px] border-card object-cover shadow-xl"
							/>
						</div>
					</motion.article>
					<motion.article
